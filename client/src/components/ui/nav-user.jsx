          ...
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-semibold">{user.firstName+" "+user.lastName|| "Unable to fetch!"}</span>
         ...
         <DropdownMenuContent
          ...
          <DropdownMenuLabel className="p-0 font-normal">
            <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
              <Avatar className="h-8 w-8 rounded-lg">
                <AvatarImage src={user.avatar} alt={user.firstName || "Unable to fetch!"} />
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                ...
                <span className="truncate text-sm">{ `@${user.username}`|| "Unable to fetch!"}</span>
